...
#     private_key_temp = rsa.generate_private_key(
#         public_exponent=65537,
#         key_size=2048,
#         backend=default_backend()
#     )
#     public_key_temp = private_key_temp.public_key()
#     return private_key_temp, public_key_temp
#
# def save_private_key(private_key_temp, filename):
#     with open(filename, "wb") as key_file:
#         key_file.write(
#             private_key_temp.private_bytes(
